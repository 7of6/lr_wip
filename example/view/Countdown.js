...
GAME.Countdown.prototype.startCountDown = function(a) {
    ...
    TweenLite.to(this.three, 1 * time2, {
        alpha: 1,
        onComplete: $.proxy(this.onThreeShown, this)
    });
...
GAME.Countdown.prototype.onThreeShown = function() {
    TweenLite.to(this.three, 1 * time, {
        alpha: 0,
        ease: Sine.easeOut,
        delay: delay
    });
    TweenLite.to(this.three.scale, 1 * time, {
        x: 0.5,
        y: 0.5,
        ease: Cubic.easeOut,
        delay: delay
    });
    TweenLite.to(this.two, 1 * time2, {
        alpha: 1,
        onComplete: $.proxy(this.onTwoShown, this),
        delay: delay
    });
...
GAME.Countdown.prototype.onTwoShown = function() {
    TweenLite.to(this.two, 1 * time, {
        alpha: 0,
        delay: delay
    });
    TweenLite.to(this.two.scale, 1 * time, {
        x: 0.5,
        y: 0.5,
        ease: Cubic.easeOut,
        delay: delay
    });
    TweenLite.to(this.one, 1 * time2, {
        alpha: 1,
        onComplete: $.proxy(this.onOneShown, this),
        delay: delay
    });
    TweenLite.to(this.one.scale, 1 * time2, {
        x: 1,
        y: 1,
        ease: Elastic.easeOut,
        delay: delay
...
GAME.Countdown.prototype.onOneShown = function() {
    TweenLite.to(this.one.scale, 1 * time, {
        x: 0.5,
        y: 0.5,
        ease: Cubic.easeOut,
        delay: delay
    });
    TweenLite.to(this.one, 1 * time, {
        alpha: 0,
        onComplete: $.proxy(this.onFinish, this),
        delay: delay
    });
    this.onComplete()
};
