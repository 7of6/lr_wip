...
GAME.BackgroundFactory = function() {
	...
	desertTextures = [];
	townTextures = ["bg_town_house1.png","bg_town_house2.png","bg_town_house3.png","bg_town_house4.png","bg_town_house5.png","bg_town_house6.png","bg_town_house7.png","bg_town_house8.png","corral.png","gallows.png"];
	indianTextures = ["tipi_closed.png","tipi_open.png","tipi_partial.png","tipi_group.png"];
...
GAME.BackgroundFactory.prototype.setTextures = function(texture){
	...
	switch(texture){
		case GAME_LEVEL.DESERT:
			backgroundTextures = desertTextures;
		break;
		case GAME_LEVEL.INDIAN_VILLAGE:
			backgroundTextures = indianTextures;
		break;
		case GAME_LEVEL.TOWN:
			backgroundTextures = townTextures;
		break;
	}
